    ...
    <nav>
        <ul id="sharing" class="dropdown-content">
            <li><a class="twitter" target="_blank"
                   href="https://twitter.com/intent/tweet?text=<?php echo urlencode('LandingPageFrameworks.com curates the top landing page builders, frameworks, and boilerplates .') ?>&url=<?php echo SITE_ADDRESS ?>">Tweet
